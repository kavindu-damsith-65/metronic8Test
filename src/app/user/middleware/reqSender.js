...
export function defaultReq(method,url,data,callback1=null,callback2=null,callback3=null){
    ...
    var options = {
        ...
        headers: {
            ...
            Authorization: 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFkbWluQGdtYWlsLmNvbSIsInVzZXJJZCI6IjEiLCJyb2xlIjoiYWRtaW4iLCJpYXQiOjE3MTkzMjI0MzJ9.5-1PQZKXLieA8BhwGyMl8EhuagonWje5Cj6lUl0QjHg' 
        },
        data: data
    };
...
// export function defaultReqwithAuth(method,url,data,callback1=null,callback2=null,callback3=null){
