...
import bg2 from '../assets/img/regBg.jpg';
...
export default function RegisterNew() {
    ...
    const handleSignupSubmit = async (values) => {
        ...
        if (createdCountry) {
            ...
            try {
                axios.post('http://localhost:3001/api/user/sign-up', signInFormData).then(response => {
                    ...
                    if (responseStatusReg === 200 || responseStatusReg === 201) {
                        ...
                        axios.post('http://localhost:3001/api/user/login', registeredUser).then(response2 => {
